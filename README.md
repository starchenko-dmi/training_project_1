...
2. processing.py содержит 4 функции:
    ...
    3. process_bank_search - Сортировка банковских операций по описанию
    4. process_bank_operations - Функция для подсчета количества операций по категориям
...
6. utils.py содержет 3 функцию
    1. receiving_financial_transactions - Функция для обработки списка транзакций из json файла, возвращает список.
    2. get_data_csv для получения данных из csv файла
    3. get_data_excel для получения данных из Excel файла
7. external_api.py содержет 1 функцию
    1. transaction_amount - Возвращает сумму транзакции в рублях

Написаны тесты на все модули тестами покрыто 96 процентов кода, отчет имеется.
...
Программа запускается из модуля main.py функцией main, предоставляю насткойки и зависимости проекта:
[tool.poetry]
